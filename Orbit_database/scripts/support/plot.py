...
# # def plot_constant_energy_curves(min_energy, max_energy, num_curves, earth_crash_x0, earth_crash_vx0, earth_crash_vy0, moon_crash_x0, moon_crash_vx0, moon_crash_vy0,which="vy"):
...
# def plot_Poincare_2D_without_printing(ax, all_orbits, all_crossings, families_str, 
#                       earth_crash_x0, earth_crash_vx0, earth_crash_vy0, moon_crash_x0, moon_crash_vx0, moon_crash_vy0,
#                       plot_second_crossings=True, which="vy", show_only_lower_quadrant=False, show_accessible_region=False, print_legend=True, colour="cycle"):
...
def plot_Poincare_2D_without_printing(ax, all_orbits, all_crossings, families_str, 
    ...
    # If show_curves_of_constant_energy is True, then plot the accessible region.
...
def plot_Poincare_2D_with_balls(all_orbits, all_crossings, families_str, 
                      earth_crash_x0, earth_crash_vx0, earth_crash_vy0, moon_crash_x0, moon_crash_vx0, moon_crash_vy0, 
                      plot_second_crossings=True, which="vy", radius=0.01, show_only_lower_quadrant=False):
...
#------------------------------------------------------------------------------
######Jack, 15 February:
#This function is for visual purposes only. If you want to actually do any calculations or anything, you should use plot_given_boxes, also in this file. (In fact, you should probably use that one in all cases).
def plot_Poincare_2D_with_boxes(all_orbits, all_crossings, families_str, 
                      earth_crash_x0, earth_crash_vx0, earth_crash_vy0, moon_crash_x0, moon_crash_vx0, moon_crash_vy0, 
                      plot_second_crossings=True, which="vy", square_length=0.01, show_only_lower_quadrant=False):
...
####This is for rectangular boxes only I think? Poor overloading of naming convention on my part, whoops.
def plot_given_boxes(boxes, earth_crash_x0, earth_crash_vx0, earth_crash_vy0, moon_crash_x0, moon_crash_vx0, moon_crash_vy0, which="vy", show_only_lower_quadrant=False):
